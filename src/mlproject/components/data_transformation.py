...
class DataTransformationConfig:
    preprocessor_ojb_file_path = os.path.join("artifacts", "preprocessor.pkl")
    ...
    def initiate_data_transformation(self,train_path,test_path):
        ...
        try:
            ...
            save_object(
                ...
                file_path=self.data_transformation_config.preprocessor_ojb_file_path,
            ...
            return (
                train_arr,
                test_arr,
                self.data_transformation_config.preprocessor_ojb_file_path,
            )
        except Exception as e:
            raise CustomException(e,sys)
